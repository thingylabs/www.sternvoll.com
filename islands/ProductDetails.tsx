...
// Remove Twind CSS and use regular Tailwind classes for description styling
const descriptionStyles =
  'text-base text-gray-600 a:hover:underline a:text-[#056CF0]'
...
export default function ProductDetails({ product }: { product: Product }) {
  ...
  return (
    <div class='w-11/12 max-w-5xl mx-auto mt-8 lg:grid lg:grid-cols-2 lg:gap-x-16'>
      ...
      {/* Product image */}
      <div class='relative w-full bg-white rounded-xl border-2 border-gray-200 mt-12 lg:mt-0 lg:col-start-2 lg:row-span-2 lg:self-start aspect-w-1 aspect-h-1'>
          ...
          {product.variants.nodes.length > 1 && (
            <div class='group'>
              <div class='relative p-4 flex items-center justify-between rounded-lg border-2 border-gray-300 group-hover:border-gray-400 transition-colors'>
                <span>{/* space holder place, don't remove */}</span>

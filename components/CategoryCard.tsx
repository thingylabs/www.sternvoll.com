...
export function CategoryCard({ backgroundImage, text, href }: CategoryCardProps) {
  return (
    <a
      href={href}
    ...
    >
      {/* Hover Overlay */}
      <div class="absolute inset-0 bg-[#002A3F] opacity-0 group-hover:opacity-100 transition-opacity duration-700 ease-in-out"></div>

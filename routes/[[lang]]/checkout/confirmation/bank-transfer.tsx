...
import {
  BankDetails,
  translationKeys as bankDetailsTranslationsKeys,
} from '@/islands/BankDetails.tsx'
...
export default function BankTransferConfirmation(
  ...
  const meta = {
    ...siteMeta,
    title: 'Bank Transfer Checkout Confirmation',
    description: 'Order confirmed with Bank Transfer',
    ...
    <>
      ...
      <div class='p-4'>
        <div class='p-8 rounded-lg shadow'>
          ...
          <BankDetails t={getT(bankDetailsTranslationsKeys)} />
        </div>
